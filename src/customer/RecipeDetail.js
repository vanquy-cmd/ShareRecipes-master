...
import { IconButton, Menu, Divider, Badge } from 'react-native-paper';
...
const RecipeDetail = ({ route, navigation }) => {
  ...
  useEffect(() => {
          ...
          setComments([
            {
              ...
              text: 'Món này rất ngon, tôi đã làm thử và cả nhà đều thích!',
            ...
            },
            {
              ...
              text: 'Cảm ơn bạn đã chia sẻ công thức. Tôi sẽ thử vào cuối tuần này.',
    ...
    const addToRecentViewed = async () => {
      try {
        await firestore().collection('RECENT_DISHES').add({
          idDishes: userId,
          dishes: [recipeId],
      ...
      >
        ...
        >
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('InfoCustomer', { userId: recipe.userId })}
            activeOpacity={0.8}
          >
            <Image 
        ...
        <View style={styles.section}>
          ...
          <View style={styles.commentsContainer}>
                  ...
                  <View style={styles.commentContent}>
                    ...
                    <View style={styles.commentActions}>
                      <TouchableOpacity style={styles.commentAction}>
                        <Icon name="thumb-up-off-alt" size={16} color="#777" />
            ...
            <TouchableWithoutFeedback 
              onPress={() => navigation.navigate('Comment', { recipeId })}
            >
